...
class TestUserRepository:
    ...
    def test_create_user_persists_to_database(
        ...
        """Test that created user is persisted to the database."""
        user = repository.create_user(
            first_name="Jane",
            last_name="Smith",
    ...
    def test_mark_user_as_verified_persists_changes(
        ...
        """Test that verification status persists to database."""
    ...
    def test_mark_user_as_verified_when_user_does_not_exist(
        ...
        """Test marking non-existent user as verified returns None."""
    ...
    def test_get_all_users_returns_all_users(
        ...
        """Test getting all users returns all created users."""
    ...
    def test_update_user_ignores_invalid_attributes(
        ...
        """Test that invalid attributes are ignored during update."""
        updated_user = repository.update(
            user.user_id,
